...
Product::Product():productId("912828U40"),productType(BOND)
{
...
Bond::Bond():Product(),productId("912828U40"),bondIdType(CUSIP),ticker("T"),coupon(0.02),maturityDate(date(2017,Dec,01))
{
